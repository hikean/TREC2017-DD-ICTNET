...
def xQuAD_Multi_source_Feedback_Ebola_NYT_fix_suggested():
    ...
    #     ('dd17-46', 'PGP'),
    # ]
    multi_xquad_lmd = [0.6, 0.5]
    source_weight = [0.2,0.5]
    tot_itr_times = 2
    xquad_lmd = 0.5
    use_jig_feedback_cnt_limit = 2
    query_expansion_feedback_cnt_limit = 1
...
def xQuAD_Multi_source_Feedback_Ebola_NYT_fix_suggested_ebolamulti_nytnot(
        xquad_lmd=0.6, s_weight=0.2, e_cnt=5, c_doc_cnt=30):
    ...
    source_weight = [s_weight, xquad_lmd]  # <2>
    tot_itr_times = 10
    use_jig_feedback_cnt_limit = 2
    query_expansion_feedback_cnt_limit = 1
    candidate_doc_cnt = c_doc_cnt  # 30 # 25-35  <4>
    every_expand_words_cnt = e_cnt  # 5 # 3 4 5 6 <3>
    ...
    logging.info("nyt...")
    xQuAD_clean_use_local_data_with_feedback_clean_code_confirm_D_fix_bug(topics=NYT_TOPICS,
                                                                          suggestor=suggestor,
                                                                          if_use_clean_text=True,
                                                                          boost_params=1,
                                                                          if_stem=True,
...
if __name__ == '__main__':
    ...
    a = [0.6, 0.5, 0.55, 0.65, 0.7, 0.75, 0.8, 0.85]  # 8
    b = [0.2, 0.15, 0.25, 0.3, 0.35, 0.4]  # 6
    c = [5, 3, 4, 6]  # 4
    d = [30, 25, 35]  # 3
    args = []
    for i in d:
    ...
    import sys
    try:
        xquad_lmd, s_weight, e_cnt, c_doc_cnt = args[int(sys.argv[1])]
