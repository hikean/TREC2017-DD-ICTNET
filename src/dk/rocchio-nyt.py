...
def get_lda(out_dir,topic_name):
    ...
    file_ldaOut = codecs.open(out_dir + "8text-{}-{}-{}-{}-{}-{}-{}-lda_topics-rocchio-nyt.txt".format(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5],sys.argv[6],topic_name), "w", "utf-8")
    file_ldaOut.write(str(ldaOut))
    
    file_id_lda = codecs.open(out_dir + "8text-{}-{}-{}-{}-{}-{}-{}-fileid_lda-rocchio-nyt.txt".format(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5],sys.argv[6],topic_name), "w", "utf-8")
...
if __name__ == '__main__':
    ...
    for ebola_query in NYT_TOPICS[0:int(sys.argv[6])]:
        ...
        for tt in range( int(sys.argv[4]) ):
            ...
            in_dir_fileid_lda = "data/lda/8text-{}-{}-{}-{}-{}-{}-{}-fileid_lda-rocchio-nyt.txt".format(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5],sys.argv[6],topic_name)
