        ...
        for _ in rslt:
            ...
            for dict_subtopics in _["subtopics"]:
                ...
                if (subtopic_id not in dict_subtopic_cnt) or (dict_subtopic_cnt[subtopic_id] < 8):
                    ...
                    dict_keyword = get_dict_keyword(dict_subtopics["passage_text"] , 8)
...
def get_lda(out_dir,topic_name):
    ...
    file_ldaOut = codecs.open(out_dir + "3-{}-{}-{}-{}-{}-{}-{}-lda_topics-rocchio-nyt.txt".format(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5],sys.argv[6],topic_name), "w", "utf-8")
    file_ldaOut.write(str(ldaOut))
    
    file_id_lda = codecs.open(out_dir + "3-{}-{}-{}-{}-{}-{}-{}-fileid_lda-rocchio-nyt.txt".format(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5],sys.argv[6],topic_name), "w", "utf-8")
...
if __name__ == '__main__':
    ...
    jig = JigClient("",tot_itr_times=tot_itr_times,base_jig_dir="/home/zhangwm/Software/dk_jig2/jig/trec-dd-jig/")
    ...
    for ebola_query in NYT_TOPICS[0:int(sys.argv[6])]:
        ...
        for tt in range( int(sys.argv[4]) ):
            ...
            in_dir_fileid_lda = "data/lda/3-{}-{}-{}-{}-{}-{}-{}-fileid_lda-rocchio-nyt.txt".format(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5],sys.argv[6],topic_name)
