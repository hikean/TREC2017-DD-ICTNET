...
def xQuAD_feedback_google_Ebola_NYT():
    # EBOLA_TOPICS = [
    ...
    google_scorer = Google_scorer(EBOLA_NYT_GOOGLE_KEY_RANK_FILE,a = google_scorer_a)
    ...
    logging.info("ebola ...")
    xQuAD_multisource_with_feedback_google_score(topics=EBOLA_TOPICS,
                                    suggestor=suggestor,
    ...
    logging.info("nyt...")
    xQuAD_feedback_google_score(topics=NYT_TOPICS,
                                                                          suggestor=suggestor,
                                                                          if_use_clean_text=True,
                                                                          boost_params=1,
                                                                          if_stem=True,
...
if __name__ == '__main__':
    xQuAD_feedback_google_Ebola_NYT()
