...
def xQuAD_Multi_source_Feedback_Ebola_NYT_fix_suggested():
    ...
    #     ('dd17-46', 'PGP'),
    # ]
    multi_xquad_lmd = [0.6, 0.7]
    source_weight = [0, 1.0] #[0.2,0.8]
    tot_itr_times = 2
    xquad_lmd = 0.8
    use_jig_feedback_cnt_limit = 2
    query_expansion_feedback_cnt_limit = 1
...
def xQuAD_Multi_source_Feedback_Ebola_NYT_fix_suggested_with_minus_feedback():
    ...
    logging.info("ebola ...")
    xQuAD_multisource_with_feedback_minus(topics=EBOLA_TOPICS,
                                                                  suggestor=suggestor,
                                                                  if_use_clean_text=True,
                                                                  boost_params=1,
                                                                  if_stem=True,
