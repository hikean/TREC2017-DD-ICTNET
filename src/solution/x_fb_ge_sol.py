...
from xQuAD_feedback_Google import *
from src.utils.Google_scorer import *


def xQuAD_feedback_google_Ebola_NYT(google_scorer_a=20):
    # EBOLA_TOPICS = [
    ...
    # ]
    # NYT_TOPICS = [
    #         ('dd17-9', 'Grenada-Cuba connections'), ('dd17-10', 'Leaning tower of Pisa Repairs'),
    #         ('dd17-11', 'Zebra mussel Hudson River'), ('dd17-12', 'Dental implants'),
    #         ('dd17-13', 'Albania pyramid scheme VEFA'), ('dd17-14', 'Montserrat eruption effects'),
    #         ('dd17-46', 'PGP'),
    # ]

    multi_xquad_lmd = [0.6, 0.6]
    source_weight = [0.2, 0.6]
    tot_itr_times = 2
    xquad_lmd = 0.6
    ...
    google_scorer_a = google_scorer_a
    use_google_help = True
    ...
    print "google_scorer_a:", google_scorer_a
    print "use_google_help:", use_google_help

    logging.info("loading google scorer...")
    google_scorer = Google_scorer(
        EBOLA_NYT_GOOGLE_KEY_RANK_FILE, a=google_scorer_a)
    ...
    logging.info("ebola ...")
    xQuAD_multisource_with_feedback_google_score(
        topics=EBOLA_TOPICS,
        suggestor=suggestor,
        ...
        google_scorer=google_scorer,
        use_google_help=use_google_help
    )

    logging.info("nyt...")
    xQuAD_feedback_google_score(
        topics=NYT_TOPICS, suggestor=suggestor,
        if_use_clean_text=True,
        boost_params=1,
        if_stem=True,
        candidate_doc_cnt=30,
...
if __name__ == '__main__':
    try:
        ...
        values = [
            ...
            1.0, 2.0, 1.4, 1.6, 1.8, 2.0, 2.3, 2.6, 2.9,
            3.5, 4.0, 4.5, 5.0, 6.0, 7.0, 8.0, 9.0, 10.,
            11, 12, 13, 14, 15, 16, 17, 18,
        ]
        xQuAD_feedback_google_Ebola_NYT(values[index])
